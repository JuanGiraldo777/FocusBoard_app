...
/**
 * Página que renderiza el registro de nuevos usuarios de FocusBoard.
 * Se usa en la ruta "/register" y está envuelta en PublicRoute.
 * Incluye toggle de tema, logo, formulario de registro y enlace a login.
 */
function Register() {
